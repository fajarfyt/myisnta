      ...
      <div class="login-container">
        <form method="post" action="<?php echo site_url('signup') ?>">
          ...
          <div class="input-div two">
            ...
            <div>
              <!-- <h5>Password</h5> -->
              <input class="input" placeholder="Fullname" type="text" name="fullname">
            </div>
          </div>
          <?= form_error('fullname', '<small class="pl-3 text-danger">', '</small>'); ?>
          ...
          <!-- <a class="btn" href="<?php echo site_url('signup') ?>">Register</a> -->
